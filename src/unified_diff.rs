...
pub(super) mod _impl {
        ...
        T: Hash + Eq + Display,
    {
        ...
        /// displaying `context_size` lines of context around each change (defaults to 3),
        ...
        T: Hash + Eq + Display,
    {
        ...
        pub fn with_writer(input: &'a InternedInput<T>, writer: W, context: ContextSize) -> Self {
            Self {
                before_hunk_start: 0,
                after_hunk_start: 0,
                before_hunk_len: 0,
